...
angular.module("website.core.analytics.google", ["website.core.analytics"]).provider("MotoGoogleAnalyticsService", [
            ...
            for (
              (a.prototype = {})._services = {},
                a.prototype.addTrackingService = function (e, t) {
                  return r instanceof l ? (angular.isString(t) || (t = e.getName()), angular.isString(t) ? ((t = t.trim()).length < 1 ? (console.warn("Tracking service name is empty"), !1) : this.hasService(t) ? (console.warn('Tracking service "' + t + '" already registered'), !1) : ((this._services[t] = e), !0)) : (console.warn("Tracking service name must be a string"), !1)) : (console.warn("Tracking service must be instance of AbstractTrackingServiceClass"), console.log("Service : ", e), console.log("Name : ", t), !1);
                },
                ...
                a.prototype.fireEvent = function (e, t, n) {
                  var i,
                    ...
                    a = {},
                    s = !1;
                  for (o in (new Date(), angular.isObject(e) && ((n = t), (e = (t = e).action)), this._services))
                    if (this._services.hasOwnProperty(o))
                      try {
                        a[o] = this._services[o].fireEvent(e, angular.copy(t), n);
                      } catch (e) {
                        console.warn("Cant fire event by service", o), console.error(e);
                      }
                  function l(e) {
                    i && u.cancel(i), s || ((s = !0), r.resolve(!0));
                  }
                  return (
              ...
              (r = null), (o = s[n]);
              try {
                angular.isString(o) ? (e.has(o) ? ((r = e.get(o)), angular.isFunction(r) && (r = new r())) : console.warn('Service or Factory "', o, '" not found')) : angular.isArray(o) ? (r = e.invoke(o)) : angular.isFunction(o) ? (r = new o()) : angular.isObject(o) && (r = o);
              } catch (e) {
                console.warn("Cant register tracking service by", o), console.error(e);
                continue;
              }
  ...
  angular.module("website.core.dependency", ["website.core.settings", "website.core.utils", "website.LiveChat", "website.core.animation", "website.core.entertainment", "website.core.media", "website.core.widgets", "website.core.analytics"]),
    ...
    function () {
      ...
      return (
        (e.getValue = function (e, t, n) {
          ...
          a = t.split(".");
          try {
            for (o = e, i = 0, r = a.length; i < r; i++) angular.isDefined(o) && (o = o[a[i]]);
            if (angular.isDefined(o)) return o;
          } catch (e) {}
          return n;
        }),
        (e.$get = function () {
  ...
  angular
    .module("website", ["core.library.config", "core.library.jsonrpc", "website.core", "website.widgets", "website.plugins", "website.moto_link", "moto.validation", "common.elements.Paginator", "ngStorage", "ipCookie"])
    .config([
      "$compileProvider",
      "$httpProvider",
    ...
    .run([
      ...
      function (e, t, n, i, o) {
        window.websiteConfig && window.websiteConfig.apiUrl ? e.setBasePath(websiteConfig.apiUrl) : e.setBasePath("/api.php"),
          t.getCookie("session-started") || (t.setCookie("session-started", Date.now()), (i.isNew = !0)),
          n.init(),
          o.addWatcher(function () {
...
angular.module("website.core", ["website.core.settings", "website.core.dependency", "website.core.analytics.google", "website.core.form", "website.core.humanize_duration"]),
  ...
  $("body").hasClass("moto-preview") ||
    $(document).ready(function () {
      ...
      e() && t(),
        ...
        (i = navigator.userAgent.match(/Edge/i) || navigator.userAgent.match(/Trident.*rv[ :]*11\./i) ? "msie" : o[1].toLowerCase()),
        window.document.body.classList.add("moto-browser_" + i),
            ...
            (e.toTop = function () {
              ...
              a.enabled &&
                n.scroll(function () {
                  t.removeAttr("style");
                  try {
                    (o = n.scrollTop() > a.topOffset) !== i && ((i = o) ? t.addClass(a.cssVisibleClass) : t.removeClass(a.cssVisibleClass), t.addClass(a.cssAnimationClass));
                  } catch (e) {}
                });
          },
        }
  ...
  angular.module("website").directive("motoBeforeInViewport", [
    ...
    function (a, s) {
      return {
        restrict: "C",
        link: function (e, t, n) {
          var i = 0 < t.closest(".moto-widget_interactive").length,
            o = {},
            r = { $scope: e, $element: t };
          (o.element = t),
            (o.$scope = e),
            (o.onEnter = n.motoBeforeInViewportOnEnter),
            (o.onLeave = n.motoBeforeInViewportOnLeave),
            (o.visibilityMode = n.motoBeforeInViewportMode),
            (o.watchAlways = !!angular.isDefined(n.motoBeforeInViewportWatchAlways) && n.motoBeforeInViewportWatchAlways),
            i
              ? (s.$onLetsDanceEvent(r, function () {
                  s.isEnabledPlaying(t) && a.startWatching(o);
                }),
                s.$onLetsStopEvent(r, function () {
                  a.stopWatching(o), t.removeClass("moto-after-in-viewport").addClass("moto-before-in-viewport");
                }))
              : a.startWatching(o);
        },
      };
  ...
  angular.module("website").service("motoBeforeInViewport", [
    function () {
      ...
      function o(e) {
        var t = r.scrollTop(),
          n = t + r.height(),
          i = e.element.offset().top,
          o = i + e.element.outerHeight();
        return !(0 < e.element.closest("." + s + ", ." + l).length || !e.element.filter(":visible").length || ("part" === e.visibilityMode ? o < t || n < i : "full" === e.visibilityMode ? !(t <= i && o <= n) : (a && console.error("motoBeforeInViewport : unexpected visibilityMode", e.visibilityMode), 0)));
      }
      function c(e) {
        return a && console.log("motoBeforeInViewport: item get in viewport", e), e.element.removeClass("moto-before-in-viewport"), e.element.addClass("moto-after-in-viewport"), angular.isString(e.onEnter) ? e.$scope.$eval(e.onEnter) : angular.isFunction(e.onEnter) && e.onEnter(), e.watchAlways ? !(e.wasInViewport = !0) : (d(e), !0);
      }
      function u() {
        e
          ? (t = !0)
          : ((function () {
              var e, t;
              for (e = 0; e < n.length; e++) o(n[e]) ? n[e].wasInViewport || (c(n[e]) && e--) : n[e].wasInViewport && ((t = n[e]), a && console.log("motoBeforeInViewport: item leave frome viewport", t), t.element.removeClass("moto-after-in-viewport"), t.element.addClass("moto-before-in-viewport"), (t.wasInViewport = !1), angular.isString(t.onLeave) ? t.$scope.$eval(t.onLeave) : angular.isFunction(t.onLeave) && t.onLeave());
            })(),
            (t = !(e = !0)),
            setTimeout(function () {
              (e = !1), t && u();
      ...
      function d(e) {
        var t = n.indexOf(e);
        -1 !== t && (n.splice(t, 1), a && console.log("motoBeforeInViewport: removed", n), 0 === n.length && (a && console.info("motoBeforeInViewport: last element removed, unbind scroll handler"), r.off("resize", u).off("scroll", u)));
      }
      (this.startWatching = function (e) {
        angular.isObject(e.element) && ((e.visibilityMode = e.visibilityMode || "part"), (e.watchAlways = e.watchAlways || !1), (e.wasInViewport = o(e)), (e.wasInViewport && (c(e), !e.watchAlways)) || (n.push(e), a && console.log("motoBeforeInViewport: added", n), 1 === n.length && (a && console.info("motoBeforeInViewport: first element added, bind scroll handler"), r.on("resize", u).on("scroll", u))));
      }),
        (this.stopWatching = d),
  ...
  angular.module("website").service("website.BrowserTabClosingConfirmation", [
    function () {
      ...
      (this.enable = function (e) {
        angular.isString(e) && (n.push(e), 1 === n.length && angular.element(window).on("beforeunload", i));
      }),
        (this.disable = function (e) {
          if (angular.isString(e)) {
            var t = n.indexOf(e);
            -1 !== t && (n.splice(t, 1), 0 === n.length && angular.element(window).off("beforeunload", i));
          }
        });
    },
  ]),
  ...
  angular.module("website.core.animation").provider("website.MotoAnimation", [
    function () {
      var e,
        n = !1,
        t = null,
        i = { disabledClass: "moto-entertainment__animation_disabled", ignoreVisibilityClass: "moto-entertainment__animation_ignore-visibility" };
      function o(e, t) {
        var n;
      ...
      return (
        (this.setOptions = function (e) {
          return !!angular.isObject(e) && (angular.extend(i, e), !0);
        }),
        ...
        (r.prototype.disableByElement = function (e) {
          n && console.log("MotoAnimation : disableByElement", e), $(e).addClass(i.disabledClass);
        }),
        (r.prototype.enableByElement = function (e) {
          n && console.log("MotoAnimation : enableByElement", e), $(e).removeClass(i.disabledClass);
        }),
        (r.prototype.isVisible = function (e) {
          var t = $(e);
          try {
            if (t.hasClass(i.disabledClass) || t.closest("." + i.disabledClass).length) return !1;
            if (t.hasClass(i.ignoreVisibilityClass) || t.closest("." + i.ignoreVisibilityClass).length) return !0;
      ...
      return {
        ...
        link: function (e, t, n) {
          var i = n.motoDependencyRequire,
            o = i;
          try {
            (o = e.$eval(o)), angular.isUndefined(o) && (o = i);
          } catch (e) {
            o = i;
          }
          angular.isFunction(o) && (o = o()), r.require(o);
        },
      };
    },
  ]),
    ...
    function (i) {
      ...
      function s(e) {
        if (!angular.isArray(e)) {
          try {
            ...
            if (i) return;
            ((i = document.createElement("script")).id = n), (i.src = t.getUrl()), (i.type = "text/javascript"), t.preInject(i), r.appendChild(i), t.postInject(i);
          } catch (e) {
            return !1;
          }
          return !0;
      ...
      (a = {
        ...
        linkedin: {
          ...
          preInject: function (e) {
            var t = i.get("preferredLocale", "en_US"),
              n = e.innerText;
  ...
  angular.module("website.core.entertainment").provider("website.Entertainment", [
    ...
    function (e) {
      var o = { animationDisabled: "moto-entertainment__animation_disabled", animationIgnoring: "moto-entertainment__animation_ignore-visibility", videoDisabled: "moto-entertainment__video_disabled", playingDisabled: "moto-entertainment__playing_disabled" },
        n = "LetsDance",
        i = "LetsRest",
        r = "LetsStop";
      function a(e) {
          ...
          function (t) {
            ...
            return (
              ...
              (e.prototype.isEnabledPlaying = function (e) {
                return !(e.hasClass(o.playingDisabled) || e.closest("." + o.playingDisabled).length);
              }),
              (e.prototype.enablePlaying = function (e) {
                return s(e) && (e = e.$element), !(!e || !e.removeClass || (e.removeClass(o.playingDisabled), 0));
              }),
              (e.prototype.disablePlaying = function (e) {
                return s(e) && (e = e.$element), !(!e || !e.addClass || (e.addClass(o.playingDisabled), 0));
              }),
              ...
              (e.prototype.letsRestDancing = function (e) {
                this.disablePlaying(e), s(e) && (e = e.$scope), a(e) && e.$broadcast(i);
              }),
  ...
  angular.module("website.core.humanize_duration").provider("motoHumanizeDuration", [
    function () {
      var e = this,
        o = { y: 315576e5, mo: 26298e5, w: 6048e5, d: 864e5, h: 36e5, m: 6e4, s: 1e3, ms: 1 },
        r = { years: "y", months: "mo", weeks: "w", days: "d", hours: "h", minutes: "m", seconds: "s", milliseconds: "ms" };
      (this.humanize = function (e, t, n) {
        var i;
        return (!n || humanizeDuration.getSupportedLanguages().indexOf(n) < 0) && (n = "en"), r[t] && (t = r[t]), (i = humanizeDuration(e * o[t], { spacer: ">", language: n, units: [t], round: !0 })).substr(i.indexOf(">") + ">".length);
      }),
        (this.$get = [
          function () {
            return e;
    ...
    function (n) {
      ...
      (this.registerItem = function (e) {
        ...
        (this.checkAndAutoplayItem = function (e) {
          function t() {
            e.autoplay.allowed && (e.autoplay.forced ? (o.pauseAll(), e.play()) : o.isAnyPlaying() || e.play());
          }
          e.autoplay.enabled &&
        ...
        (this.autoplayFailed = function () {
          t ||
            ...
            $("body").on("click", function e() {
              o.areAllItemsReady() && ((t = !1), $("body").off("click", e), o.runAutoplayProcedure());
            }));
        }),
        (this.runAutoplayProcedure = function () {
          i.forEach(function (e) {
            o.checkAndAutoplayItem(e);
          });
        });
    },
  ]),
  angular.module("website.core.utils").service("website.ElementHeightWatcherClass", [
    function () {
      function e(e) {
        ...
        (this._options = angular.copy(this._options)), angular.extend(this._options, e), (this.$element = $(e.$element)), (this._onResizeHandler = this.update.bind(this)), $(window).on("resize", this._onResizeHandler), (this._timer = setInterval(this.update.bind(this), this._options.delay));
      }
      return (
  ...
  angular.module("website.core.settings").provider("motoWebsiteSettingsService", [
    function (n) {
      ...
      (this.get = function (e, t) {
        return e === n ? o : o[e] !== n ? o[e] : t || null;
      }),
        (this.set = function (e, t) {
          if (!angular.isObject(e)) return (o[e] = t), i;
  ...
  angular.module("website.core.widgets").service("website.ContentWidgetClass", [
    ...
    function (e, t, n, i) {
      function o(e) {
        var t;
        angular.isElement(e) ? (t = e) : !angular.isElement(e) && angular.isObject(e) && ((this.id = e.id), (this.name = e.name), (t = e.$element), this.setScope(e.$scope)), angular.isElement(t) && this.setElement(t), (this.children = new n());
      }
      return (
        (o.prototype._debug = !1),
        (o.prototype.id = null),
        (o.prototype.name = null),
        (o.prototype.$element = null),
        (o.prototype.$scope = null),
        (o.prototype.$content = null),
        (o.prototype.children = null),
        (o.prototype._parent = null),
        (o.prototype.setParent = function (e) {
          return this._parent ? this._parent === e : e instanceof o && ((this._parent = e), !0);
        }),
        ...
        (o.prototype.setElement = function (e) {
          return this.$element ? this.$element === e : !!angular.isElement(e) && ((this.$element = e), (this.id = e.attr("id") || this.id), (this.name = e.attr("data-widget") || this.name), (this.$content = e.find("#" + this.id + "__content") || this.$element), !0);
        }),
        (o.prototype.setScope = function (e) {
        ...
        (o.prototype.onVisibleImmediately = function (e) {
          this._debug && console.warn(this.name, "onVisibleImmediately #", this.id, e), this.onArriving(e), this.onArrived(e);
        }),
        (o.prototype.onArriving = function (e) {
          this._debug && console.warn(this.name, "onArriving #", this.id, e), "onArriving" === e.startAnimation && t.letsStartAnimation(this), t.letsDance(this), i.elementIsVisible(this.$element);
        }),
        (o.prototype.onArrived = function (e) {
          this._debug && console.warn(this.name, "onArrived #", this.id, e), "onArrived" === e.startAnimation && t.letsStartAnimation(this);
        }),
        (o.prototype.onVanishing = function (e) {
          this._debug && console.warn(this.name, "onVanishing #", this.id, e), t.letsStopAnimation(this), t.letsStopDancing(this), i.elementIsInvisible(this.$element);
        }),
        (o.prototype.onVanished = function (e) {
          this._debug && console.warn(this.name, "onVanished #", this.id, e);
        }),
        (o.prototype.onResizing = function (e) {
    ...
    function () {
      function i(e, t, n, i) {
        var o,
          r = e.length,
          a = [];
        for (o = n; o < r && (t(e[o]) && a.push(e[o]), !(-1 < i && a.length === i)); o++);
        return a;
      }
      function t(e) {
      ...
      return (
        ...
        (t.prototype.first = function (e, t) {
          var n;
          return (n = angular.isFunction(e) ? i(this._items, e, 0, 1)[0] : this.getByIndex(0)), angular.isUndefined(t) && (t = null), n || t;
        }),
    ...
    function (i, e) {
      ...
      return (
        ...
        (t.prototype.setDefaultParent = function (e) {
          return !!((e && e instanceof i) || null === e) && ((o = e), !0);
        }),
        ...
        (t.prototype.forget = function (e) {
          var t, n;
          if ((e instanceof i ? (t = e) : angular.isString(e) && (t = this._collection.getById(e)), !t)) return !1;
          (n = t.children.all()).length && n.forEach(this.forget.bind(this)), this._collection.removeById(t.id);
        }),
        (t.prototype.registry = function (e) {
          var t, n;
          return !!angular.isObject(e) && (e instanceof i || (e = new i(e)), e instanceof i && (this.isExists(e.id) && this.forget(e.id), !this.isExists(e.id) && !!this._collection.push(e) && ((t = e.$element.attr("data-parent-id")), (n = this._collection.getById(t)) ? e.setParent(n) : o && e.setParent(o), (n = e.getParent()) && n.addChild(e), e)));
        }),
  ...
  angular.module("website.LiveChat").provider("websiteLiveChat", [
    ...
    function (t) {
      ...
      return (
        ...
        ((o.prototype = {})._provider = null),
        (o.prototype._options = {}),
        (o.prototype._booted = !1),
        (o.prototype._booting = !1),
        ...
        (r.prototype.registerApiConnector = function (e, t) {
          return !angular.isString(e) || e.trim().length < 1 ? (console.warn("LiveChatProvider : cant register provider, invalid name", e), !1) : angular.isFunction(t) ? (t.prototype instanceof o ? ((e = e.trim()), (i[e] = { name: e, constructor: t }), !0) : (console.warn("LiveChatProvider : invalid constructor", t), !1)) : (console.warn("LiveChatProvider : cant register provider constructor", t), !1);
        }),
        (r.prototype.isRegisteredProvider = function (e) {
          return !!i[e];
        }),
        (r.prototype.getApiProviderConstructor = function (e) {
          return this.isRegisteredProvider(e) ? i[e].constructor : (console.warn('LiveChatProvider : provider "', e, '" not exists'), null);
        }),
        ...
        (e = new r()),
        (((a.prototype = Object.create(o.prototype)).constructor = a).prototype.boot = function () {
          return !(
            this._booted ||
            this._booting ||
            ((this._booting = !0),
            ...
            !window.__lc.license ||
              ((function (e, t, n) {
                function i(e) {
                  return o._h ? o._h.apply(null, e) : o._q.push(e);
                }
                var o = {
                  _q: [],
                  _h: null,
...
angular.module("website").directive("motoBackgroundVideo", [
    ...
    return {
      ...
      link: function (e, t) {
        ...
        i &&
          ...
          n.attr("playsinline", ""),
          r.$onLetsDanceEvent(o, function (e) {
            if ((t.motoVideoBackground(), i.paused && !r.isDisabledPlaying(t)))
              try {
                i.play()
                  .then(
                    function () {},
          ...
          r.$onLetsRestEvent(o, function (e) {
            i.paused || i.pause();
          }),
          r.$onLetsStopEvent(o, function (e) {
            i.paused || (i.pause(), (i.currentTime = 0));
          }));
      },
    };
  },
  ...
  angular.module("website").directive("motoCookieNotification", [
    ...
    function (r) {
      return {
        restrict: "C",
        link: function (e, i) {
          var o = i.attr("data-content-hash");
          r.getCookie("cookie-notification-applied") !== o && i.addClass("moto-cookie-notification_visible"),
            (e.closeNotification = function (e, t) {
              var n = t ? { expires: t } : null;
              e.preventDefault(), i.fadeOut(), r.setCookie("cookie-notification-applied", o, n);
            });
        },
      };
    },
  ...
  angular.module("website.moto_link").run([
    function () {
      ...
      $("body").on("click", ".moto-link[data-action=page]", function (e) {
        return $(e.currentTarget).parents(".mfp-content").length && t(window.location.href) === t(e.currentTarget.href) && n(e.currentTarget.href) && !$(".mfp-content").find("a.moto-anchor[name=" + n(e.currentTarget.href) + "]").length && $.magnificPopup.close(), e;
      });
    },
  ]),
  angular.module("website.moto_link").directive("motoInitLightboxGallery", function () {
    return {
      ...
      link: function (e, t, n) {
        t.magnificPopup({
          delegate: "a[data-action=lightbox][data-moto-lightbox-link]",
          type: "image",
          tClose: "",
          tLoading: "",
          ...
          image: {
            titleSrc: function (e) {
              var t = angular.element(e.el.context).closest("[data-moto-lightbox-item]").find("[data-moto-lightbox-caption]").clone(),
                n = t.attr("data-moto-lightbox-caption-class");
              return (
                n &&
    ...
    function (i) {
      $("body").on("click", ".moto-link[data-action=lightbox]", function (e) {
        ...
        (!n.closest("[data-moto-lightbox-caption]").length && n.closest("[data-moto-init-lightbox-gallery]").length) ||
          ...
          e.preventDefault(),
          i(function () {
            $.magnificPopup.close(), $.magnificPopup.open({ items: { tClose: "", tLoading: "", src: n.attr("href"), title: t || n.attr("title") || "", type: "image" } });
          }));
      });
    },
  ]),
        ...
        if (angular.isObject(e))
          switch (e.action) {
            case "popup":
              ...
              break;
            case "lightbox":
              angular.isString(e.url) && $.magnificPopup.open({ items: { tClose: "", tLoading: "", src: e.url, type: "image" } });
              break;
            default:
    ...
    function (o) {
      $("body").on("click", ".moto-link", function (e) {
        var t = $(e.currentTarget),
          ...
          i = t.data("action");
        if (((n = parseInt(n)), "popup" === i && !(0 < n))) return !1;
        "popup" === i && (e.preventDefault(), o.openPopup(n));
      });
    },
  ]),
  angular.module("website.moto_link").run([
    function () {
      $("body").on("click", "a[data-moto-widget-actions-scroll-to]", function (e) {
        var t = $(e.currentTarget),
          n = t.data("anchor"),
          i = 1e3 * parseFloat(t.data("time") || "0.4");
        if (angular.isDefined(n)) {
          var o = $('a[name="' + n + '"]');
          e.preventDefault(), o.length && $("html, body").animate({ scrollTop: o.offset().top }, i);
        }
      });
    },
  ]),
    ...
    function (c, n, e, u, o, d, i, m, p) {
      ...
      function a(i, o) {
        var r,
          ...
          s = h();
        function l() {
          (s = !1), g && g.$destroy(), r && (r = e.reject(r, "rejecting"));
        }
        (o = angular.isFunction(o) ? o : angular.noop),
                  ...
                  callbacks: {
                    open: function () {
                      f(e.properties.width),
                        (g = c.$new()),
                        (t = u(t)(g)),
                        m.letsDance({ id: i, name: "@popup", $scope: g, $element: t }),
                        (n = p.addWatcher(function () {
                          var e = window.document.createEvent("UIEvents");
                          e.initUIEvent("resize", !0, !1, window, 0), window.dispatchEvent(e);
                        }, t[0])),
                        o();
      ...
      (this.init = function () {
        ...
        ($.magnificPopup.proto._close = function () {
          ...
          i.isNew && o.removeLocalStorageItem("popups-session");
      }),
        (this.pleaseOpenPopup = function (e, t) {
          var n, i;
          h() ? ((n = e), (i = t), r.push({ id: n, callback: i })) : a(e, t);
        }),
        (this.openPopup = a),
        (this.updateDataInStorage = function (e, t) {
          var n,
            i = "popups-storage";
          "session" === t && (i = "popups-session"), (n = o.getLocalStorageItem(i, {}))[e] ? n[e].shows++ : (n[e] = { shows: 1 }), (n[e].timestamp = Date.now()), o.setLocalStorageItem(i, n);
        }),
        (this.shouldPopupBeOpened = function (e, t, n) {
          var i;
          return !("always" !== t && ("session" === t ? (i = o.getLocalStorageItem("popups-session", {}))[e] : ((i = o.getLocalStorageItem("popups-storage", {})), ("amount" === t && i[e] && i[e].shows >= n.shows) || ("overtime" === t && i[e] && Date.now() - i[e].timestamp < 1e3 * n.overtime))));
        });
    },
  ]),
    ...
    function (e, o) {
      ...
      function f(e, i, o) {
        e.find(".moto-widget[data-sticky-preset]").each(function (e, t) {
          var n = $(t);
          n.removeClass("moto-preset-" + n.attr(i)), n.addClass("moto-preset-" + n.attr(o));
        });
      }
      function h(e) {
        try {
          "static" === (i = e).options.mode || ((c = (a = i.isAttached || i.options.hidden ? i.$pseudoElement : i.$element).get(0).getBoundingClientRect()), (s = !1), (l = i.options.offset), (o = parseInt(a.css("marginTop")) || 0), "smallHeight" === i.options.mode ? ((r = Math.max(document.documentElement.clientHeight, window.innerHeight || 0)), c.top + a.outerHeight() < r) : ("top" === i.options.direction && (s = c.top - o < l), s))
            ? ((n = e).isAttached ||
                (n.$element
                  .show()
                  .addClass(d.attachedClass)
                  .addClass(d.attachedClass + "_" + n.options.direction),
                (n.isAttached = !0),
                f(n.$element, "data-preset", "data-sticky-preset")),
              (function (e) {
                var t = 0;
                try {
                  e.$pseudoElement.show(),
                    u || e.$element.innerWidth(e.$pseudoElement.innerWidth()),
      ...
      function i(e, t, n) {
        var i,
          ...
          u = !!c.length;
        try {
          if (0 < t.parent().closest("." + d.bootstrappedClass).length) return g() && console.log("motoSticky : DETECTED PARENTS");
          (o = e.$eval(n.motoSticky)),
            u &&
              ((o.offset = 50),
              (s = e),
            ...
            (i = { $scope: e, $element: t, $attrs: n, options: angular.extend({}, m, o), isAttached: !1 }),
            o.mobile && t.addClass(d.mobileClass),
            (a = i).$element.find(".lazyload").each(function (e, t) {
              $(t).one("load", function () {
                h(a);
              });
            }),
            (r = i).$pseudoElement || ((r.$pseudoElement = angular.element('<div class="' + d.pseudoElementClass + '"></div>')), r.$pseudoElement.insertAfter(r.$element), r.options.hidden ? r.$pseudoElement.height(0) : (r.$pseudoElement.hide(), r.$pseudoElement.height(r.$element.outerHeight(!0)), r.$pseudoElement.width(r.$element.innerWidth()))),
            h(i),
            p.push(i);
        } catch (e) {
          g() && console.info("motoSticky : ERROR on addObject", e);
        }
      }
      return (
        (function e(t) {
          var n, i;
          try {
            if ((t || (r && o.cancel(r), (r = o(e, d.interval))), !a || p.length < 1)) return;
            for (a = !1, i = 0, n = p.length; i < n; i++) h(p[i]);
            u = !1;
          } catch (e) {
            g() && console.info("motoSticky : ERROR on checkObjects", e);
          }
        })(),
        t.scroll(n).resize(n),
        {
          restrict: "A",
          compile: function (e) {
            return e.addClass(d.bootstrappedClass), i;
          },
        }
      );
    },
  ...
  angular.module("website").service("website.MotoStorageService", [
    ...
    function (n, i) {
      var o = window.websiteConfig.addressHash + "_",
        r = { path: websiteConfig.relativeAddress };
      (this.getLocalStorageItem = function (e, t) {
        return (t = t || !1), n[o + e] || t;
      }),
        ...
        (this.setCookie = function (e, t, n) {
          return (n = n || {}), (n = angular.merge({}, r, n)), i(o + e, t, n);
        }),
  ...
  angular.module("moto.validation").directive("motoClearValidationOnChange", function () {
    return {
      ...
      link: function (e, t, n, i) {
        var o, r, a;
        !(o = e.$eval(n.motoClearValidationOnChange)) && n.motoClearValidationOnChange && (o = n.motoClearValidationOnChange),
          o && !angular.isArray(o) && (o = [o]),
          i.$parsers.push(function (e) {
            for (r = 0, a = o.length; r < a; r++) i.$setValidity(o[r], !0);
            return e;
          });
      },
    };
  ...
  angular.module("website").directive("body", [
    ...
    function (n, i, o) {
      return {
        restrict: "E",
        compile: function (e) {
          var t = o.registry({ id: "body", name: "@body", $scope: n, $element: e });
          return (
            o.setDefaultParent(t),
            {
              post: function () {
                o.setDefaultParent(null), i.letsDance(t);
              },
            }
          );
        },
  ...
  (function (s) {
    ...
    "undefined" != typeof google && void 0 !== google.maps && (l = "LOADED"),
      ...
      (s.fn.motoGoogleMap = function (e) {
        ...
        return (
          ...
          (a.prototype.update = function (e) {
            var t,
              n = this.getByUid(e.uid);
            if (!angular.isObject(e)) return !1;
            for (t in (p((e = angular.copy(e))), e))
              if (e.hasOwnProperty(t) && "_" !== t[0] && "$" !== t[0] && "function" != typeof e[t])
                try {
                  "position" === t ? n.setPosition(e[t]) : n.set(t, e[t]);
                } catch (n) {
            ...
            instance: function () {
              return (
                (e.styles = r[e.theme]),
                {
                  ...
                  _markers: new a((t = new google.maps.Map(o, e))),
      ...
      (s.fn.motoGoogleMap.setApiKey = function (e) {
        if ("string" != typeof e) throw new Error("[motoGoogleMap.setApiKey] Bad argument: ApiKey must be a string, got " + typeof e);
      ...
      return (
        ...
        (e.prototype = {
          ...
          $trigger: function (e, t) {
            ...
            for (n = 0, i = this._events[e].length; n < i; n++) this._events[e][n](o, t);
          },
          reset: function () {
            (this.pageRange = 5), (this.pageCount = 0), (this.first = null), (this.firstNumber = 0), (this.previous = null), (this.previousNumber = null), (this.current = null), (this.currentNumber = 0), (this.next = null), (this.nextNumber = null), (this.last = null), (this.lastNumber = null), (this.pages = []), (this.pagesInRange = []);
          },
          ...
          updatePagesInRange: function () {
            ...
            for (t - n < this.pageRange && (n -= this.pageRange - (t - n)), n < 0 && (n = 0), this.pagesInRange.length = 0, e = n; e < t && (this.pagesInRange.push(this.pages[e]), !(this.pagesInRange.length >= this.pageRange)); e++);
          },
              ...
              !(
                ...
                ((this.pages = (function (e) {
                  var t,
                    ...
                    i,
                    o = [];
                  for (t = 0, n = e.length; t < n; t++) o.push((i = e[t]) instanceof r ? i : new r(i, t + 1));
                  return o;
                })(e.pages)),
                (this.pageCount = e.pages.length),
                (this.firstNumber = 1),
                (this.first = this.getFirstPage() || new r(null, 1)),
                (this.last = this.getLastPage() || new r(null, this.pageCount + 1)),
          ...
          setCurrentPageNumber: function (e) {
            return (e = parseInt(e)), !isNaN(e) && (1 < (this.currentNumber = e) && (this.previousNumber = e - 1), e < this.pages.length && (this.nextNumber = e + 1), (this.previous = this.getPreviousPage() || new r(null, this.previousNumber)), (this.current = this.getCurrentPage() || new r(null, this.currentNumber)), (this.next = this.getNextPage() || new r(null, this.nextNumber)), this.updatePagesInRange(), !0);
          },
          selectPage: function (e) {
            angular.isNumber(e) && (e = this.getPageByNumber(e)), e instanceof r && this.$trigger("selected", e.value);
          },
        }),
        e
      );
    ...
    function (g, f, h) {
      return {
        ...
        link: function (e, t, n) {
          ...
          angular.isObject(p) && (i = { enabled: !0, allowed: h.isEnabledPlaying(t), forced: p.forced, startOn: p.onlyWhenVisible ? "onFirstVisible" : "default" }),
            (a = t.find("audio")),
            (s = t.find("source")),
            ...
            a.mediaelementplayer({
              ...
              features: [l ? "playlistfeature" : "", l ? "prevtrack" : "", "playpause", l ? "nexttrack" : "", c && c.stop ? "stop" : "", "progress", "current", "duration", "mototrackname", "volume", l ? "playlist" : "", c && c.loop ? "motoloop" : "", c && c.download ? "motodownload" : "", "motoskin"],
              plugins: [],
            ...
            h.$onLetsDanceEvent(m, function () {
              (o.autoplay.allowed = h.isEnabledPlaying(t)), g.checkAndAutoplayItem(o);
            }),
            h.$onLetsStopEvent(m, function () {
              (o.autoplay.allowed = !1), o.pause();
            });
        },
      };
    },
            ...
            (t.request = { password: "", pageId: n.destinationPageId }),
              (t.submit = function () {
                t.request.pageId &&
                  ...
                  t.authForm.$valid &&
                    i.loginToPageByPassword(t.request).then(
                      function () {
                        o.location.reload();
                      },
                      function (e) {
      ...
      return {
        ...
        link: function (e, t, n) {
          var i,
            ...
            s = ((i = a).itemsCount < 2 && (i.showPaginationDots = !1), { mode: "horizontal", auto: !1, pause: 1e3 * i.slideshowDelay, controls: i.showNextPrev, pager: i.showPaginationDots, slideWidth: i.slideWidth, minSlides: i.minSlides, maxSlides: i.maxSlides, moveSlides: i.moveSlides, slideMargin: i.margins, stopAutoOnClick: !0, shrinkItems: !0 });
          (s.onSliderLoad = function () {
            ...
            s.controls &&
              ...
              (s.onSliderResize = function (e) {
                ...
                try {
                  (t = e.parent().parent()), 1 < (n = $(t.find("> .bx-controls")[0])).find(".bx-pager > .bx-pager-item").length ? n.find(".bx-controls-direction > a").removeClass("disabled") : n.find(".bx-controls-direction > a").addClass("disabled");
                } catch (e) {}
                return !0;
              }.bind(t)),
            (o = t.bxSlider(s)),
            ...
            c.$onLetsDanceEvent(r, function () {
              o.reloadSlider(angular.extend({}, s, { startSlide: o.getCurrentSlide() })), c.isDisabledPlaying(t) || (a.slideshowEnabled && o.startAuto(), l(o.redrawSlider));
            }),
        ...
        link: function (e, t) {
          (e.options.progress.animation || e.options.progressBar.animation) &&
            n.startWatching({
              element: t,
              onEnter: function () {
                e.options.progress.animation && t.motoCounter({ countTo: e.options.progress.custom ? e.options.progress.customValue : e.options.progress.value, duration: e.options.progress.animationDuration, elementSelector: ".moto-widget-completion_bar_circular__progress-value" }), e.options.progressBar.animation && t.find(".moto-widget-completion_bar_circular__svg").get(0).classList.add("moto-widget-completion_bar_circular__svg-animated");
              },
            });
        },
      };
          ...
          compile: function (i) {
            return {
              pre: function (e) {
                ...
                i.closest(".moto-widget_interactive").length < 1 ||
                  (i.on("click", t),
                  i.on("focus", "input, select, textarea, button, a", n),
                  e.$on("$destroy", function () {
                    i.off("click", t), i.off("focus", n);
                  }));
              },
            };
          },
    ...
    .controller("widget.ContactForm.Controller", [
      ...
      function (n, e, t, i, o, r) {
        var a,
          ...
          p = /^[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z0-9-]+)$/;
        if (((n.message = {}), (n.placeholder = {}), (n.hash = ""), (n.attachments = []), (n.attachment = {}), m.length)) for (u = 0, d = m.length; u < d; u++) (l = (s = angular.element(m[u])).attr("name")) && ((n.message[l] = n.message[l] || ""), (n.placeholder[l] = "checkbox" === l ? e.find(".moto-widget-contact_form-checkbox-text").text() || l : s.attr("placeholder") || l));
        function g() {
          (n.emailError = !0), (n.sending = !1), r.disable(a);
        }
        function f(e) {
          if (e.error) return g(e.error);
          (n.emailSent = !0),
            (n.triedToSend = !1),
            (n.sending = !1),
        ...
        (n.validateEmailOnBlur = function () {
          (n.contactForm.email.$pristine = !1), "" !== n.contactForm.email.$viewValue ? (p.test(n.contactForm.email.$viewValue) ? ((n.contactForm.email.emailInvalid = !1), n.contactForm.email.$setValidity("pattern", !0)) : ((n.contactForm.email.emailInvalid = !0), n.contactForm.email.$setValidity("pattern", !1))) : (n.contactForm.email.emailInvalid = !1);
        }),
          (n.validate = function (e) {
            "email" === e && n.validateEmailOnBlur();
          }),
          (n.validateCheckbox = function () {
            c && ((n.contactForm.checkbox.$pristine = !1), n.contactForm.checkbox.$viewValue ? ((n.contactForm.checkbox.$invalid = !1), n.contactForm.checkbox.$setValidity("required", !0)) : ((n.contactForm.checkbox.$invalid = !0), n.contactForm.checkbox.$setValidity("required", !1), (n.contactForm.$valid = !1)));
          }),
          ...
          (n.submit = function () {
            n.sending ||
              ...
              (n.sending = !0),
              (n.emailError = !1),
              "object" == typeof n.contactForm.$error.required
                ...
                ? ((a = "widget.ContactForm_" + new Date().getTime()),
                  ...
                  n.attachment && n.attachment.name
                    ? ((n.message._attachments = n.attachment.name ? 1 : 0),
                      i
                        .upload({ method: "POST", url: t.getApiPath(), file: n.attachment, data: { jsonrpc: "2.0", id: 1, method: "Widget.ContactForm.sendMessage", params: { message: n.message, placeholder: n.placeholder, hash: n.hash } }, headers: { "X-Requested-With": "XMLHttpRequest" } })
                        .success(f)
                        .error(g))
                    : t.sendMessage({ message: n.message, placeholder: n.placeholder, hash: n.hash }).success(f).error(g))
                : (n.sending = !1));
          });
      },
    ]),
      ...
      return {
        ...
        link: function (e, t, n) {
          ...
          try {
            ...
            (r = !0),
              (i = n.params || {}),
              angular.isString(i) && (i = angular.fromJson(i)),
              (i.url = n.url),
              (window.disqus_config = function () {
                this.language = i.language;
              }),
              i.use_identifier ? delete i.url : delete i.identifier,
              delete i.use_identifier,
              i && i.shortname && "" != i.shortname && o.get("disqus").setParams(i).require();
          } catch (e) {}
        },
      };
    },
  ...
  angular.module("website.widget.grid_gallery", []).directive("motoGridGalleryOptions", function () {
    return {
      ...
      priority: 450,
      link: function (e, t, n) {
        var i = e.$eval(n.motoGridGalleryOptions);
        t.justifiedGallery({ rowHeight: i.rowHeight, maxRowHeight: i.fixedHeight ? i.rowHeight : 0, margins: i.margins, lastRow: i.lastRow, captions: i.showCaptions, cssAnimation: !0 });
      },
    };
  }),
    ...
    .controller("widget.MailChimp.Controller", [
      ...
      function (n, e, t, i, o) {
        var r,
          ...
          m = u.length;
        if (((n.listId = ""), (n.message = {}), (n.emailSent = !1), (n.showSuccessMessage = !1), (n.triedToSend = !1), (n.emailError = !1), (n.isSubscribed = !1), m)) for (l = 0; l < m; l++) (s = (a = angular.element(u[l])).attr("name")) && (n.message[s] = n.message[s] || a.attr("value") || "");
        function p() {
          (n.emailSent = !0),
            (n.triedToSend = !1),
            (n.sending = !1),
        ...
        function g(e) {
          (n.emailError = !0), (n.sending = !1), o.disable(r), e.data && e.data.errors && e.data.errors.detail && (n.isSubscribed = e.data.errors.detail.match(/is already a list member/g));
        }
        (n.validateEmailOnBlur = function () {
          (n.subscribeForm.email.$pristine = !1), "" != n.subscribeForm.email.$viewValue ? (d.test(n.subscribeForm.email.$viewValue) ? ((n.subscribeForm.email.emailInvalid = !1), n.subscribeForm.email.$setValidity("pattern", !0)) : ((n.subscribeForm.email.emailInvalid = !0), n.subscribeForm.email.$setValidity("pattern", !1))) : (n.subscribeForm.email.emailInvalid = !1);
        }),
          ...
          (n.validateCheckbox = function () {
            c && ((n.subscribeForm.checkbox.$pristine = !1), n.subscribeForm.checkbox.$viewValue ? ((n.subscribeForm.checkbox.$invalid = !1), n.subscribeForm.checkbox.$setValidity("required", !0)) : ((n.subscribeForm.checkbox.$invalid = !0), n.subscribeForm.checkbox.$setValidity("required", !1), (n.subscribeForm.$valid = !1)));
          }),
          (n.checkboxChanged = function () {
          ...
          (n.submit = function () {
            n.sending ||
              ...
              (n.emailError = !1),
              (n.isSubscribed = !1),
              "object" == typeof n.subscribeForm.$error.required
              ...
              n.validate("email"),
              n.validateCheckbox(),
              n.subscribeForm && n.subscribeForm.$valid && !n.subscribeForm.emailInvalid ? ((r = "widget.MailChimp_" + new Date().getTime()), o.enable(r), (n.message.list_id = n.listId || ""), t.subscribe({ request: n.message }).success(p).error(g)) : (n.sending = !1));
          });
      },
    ]),
      ...
      e.on("resize", function () {
        ...
        if (o !== i && (o = i))
          for (e = 0, t = s.length; e < t; e++)
            try {
              (n = s[e]).$element.find(".moto-widget-menu-item-has-submenu_opened").removeClass("moto-widget-menu-item-has-submenu_opened"), n.$element.find(".moto-widget-menu-sublist").css("display", ""), n.$element.removeClass("moto-widget-menu-mobile-open");
            } catch (e) {}
      }),
      {
        restrict: "C",
        ...
        link: function (e, t) {
          var n = t.find(".moto-widget-menu-toggle-btn"),
            i = t.find(".moto-widget-menu-link"),
            o = t.find(".moto-widget-menu-item-has-submenu"),
            r = o.find(".moto-widget-menu-sublist"),
          ...
          s.push({ $element: t, $toggleButton: n }),
            ...
            o.length &&
              a.on("click", function (e) {
                n.is(":hidden") || (e.stopPropagation(), e.preventDefault(), $(this).closest(".moto-widget-menu-item-has-submenu").toggleClass("moto-widget-menu-item-has-submenu_opened").find("> .moto-widget-menu-sublist").toggle());
              });
        },
      }
    );
        ...
        link: function (e, t, n) {
          ...
          (c.id = t.closest(".moto-widget-slider").attr("id")),
            ...
            c.thumbnailPagination.enable &&
              ...
              (i.pagerCustom = a),
              (i.onSlideBefore = function (e, t, n) {
                var i = a.children(":nth-child(" + (n + 1) + ")"),
                  o = i[0].offsetLeft - a.innerWidth() / 2 + i.innerWidth() / 2;
                a.animate({ scrollLeft: o }, 400);
              })),
            (o = t.bxSlider(i)),
            e.$on("$destroy", o.destroySlider),
            d.$onLetsDanceEvent(l, function () {
              (r = o.find(".bx-caption")).removeClass("bx-caption"), r.css("display", "none"), o.reloadSlider(angular.extend({}, i, { startSlide: o.getCurrentSlide() })), r.addClass("bx-caption"), r.css("display", ""), d.isDisabledPlaying(t) || (c.slideshowEnabled && o.startAuto(), u(o.redrawSlider));
            }),
    ...
    function (i) {
      return {
        ...
        link: function (e, t) {
          ...
          window.IN && angular.isFunction(window.IN.parse) ? n() : i.$on("motoDependencyService.linkedin.loaded", n);
        },
      };
    },
  ]),
      ...
      function (y, b, w) {
        return {
          ...
          link: function (e, t, n) {
            ...
            angular.isObject(g) && (i = { enabled: !0, allowed: w.isEnabledPlaying(t), forced: g.forced, startOn: g.onlyWhenVisible ? "onFirstVisible" : "default" }),
              ...
              (o = y.registerItem({
                ...
                play: function () {
                  function e() {
                    b.when(a.domNode.play())
                      .then(function () {
                        m ? a.domNode.pause() : a.domNode.play();
                      })
                      .catch(function () {
                        (m = !0), y.autoplayFailed();
                      });
                  }
                  (m = !1),
                    4 === a.readyState
              ...
              w.$onLetsDanceEvent(p, function () {
                a && a.globalResizeCallback(), (o.autoplay.allowed = w.isEnabledPlaying(t)), y.checkAndAutoplayItem(o);
              }),
              w.$onLetsStopEvent(p, function () {
                (o.autoplay.allowed = !1), o.pause();
              }),
              f &&
                f.pip &&
                ...
                "disablePictureInPicture" in c[0] && "pictureInPictureEnabled" in document
  ...
  angular.module("website.widget.accordion").directive("motoWidgetAccordion", [
    "website.WidgetsRepository",
    function (n) {
      var i = { startAnimation: "onArriving" };
      return {
        restrict: "C",
        scope: !0,
        compile: function (e) {
            ...
            post: function () {
              e.motoAccordion({
                onOpening: function (e) {
                  t.getChild(e.id).onArriving(i);
                },
                onOpened: function (e) {
                  t.getChild(e.id).onArrived(i);
                },
  ...
  (function (d) {
    var a = "moto-widget-accordion__item_open",
      i = "moto-widget-accordion__item_collapsing",
      m = d(window);
    function p(e, t, n) {
      (e.opened = !1),
        e.$wrapperNode.slideUp({
          duration: 400,
          start: function () {
            e.$node.addClass(i).removeClass(a), t && t(e);
          },
          complete: function () {
            e.$node.removeClass(i), n && n(e);
          },
        });
    }
    function g(t, e, n) {
      (t.opened = !0),
        t.$wrapperNode.slideDown({
          duration: 400,
          start: function () {
            t.$node.addClass(i).addClass(a), e && e(t);
          },
          complete: function () {
            var e;
            t.$node.removeClass(i), (e = t.$node).offset().top < d(document).scrollTop() && d("html, body").animate({ scrollTop: e.offset().top }, 400), n && n(t);
          },
        });
    }
      ...
      "object" != typeof l && (l = {}),
        (c = (function (e, t) {
          var n,
            ...
            o,
            r = {};
          for (o = 0; o < e.length; o++) (r[(n = (i = d(e[o])).attr("id") || i.attr("data-widget-id"))] = { id: n, $node: i, opened: i.hasClass(a), $wrapperNode: i.children(".moto-widget-accordion__content-wrapper") }), r[n].opened ? t.onOpened && t.onOpened(r[n]) : t.onClosed && t.onClosed(r[n]);
          return r;
        ...
        this.on("click", ">.moto-widget-accordion__wrapper>.moto-widget-accordion__item>.moto-widget-accordion__header", function (e) {
          var t,
            ...
            s = c[a];
          s.opened || !u
            ? ((t = s), (n = l.onOpening), (i = l.onOpened), (o = l.onClosing), (r = l.onClosed), t.opened ? p(t, o, r) : g(t, n, i))
            : ((function (e, t, n) {
                var i;
                for (i in e) e.hasOwnProperty(i) && e[i].opened && p(e[i], t, n);
              })(c, l.onClosing, l.onClosed),
              g(s, l.onOpening, l.onOpened)),
            m.resize();
        });
    };
  })(jQuery),
  ...
  angular.module("website.widget.actions.open_popup", []).directive("motoWidgetActionsOpenPopup", [
    ...
    function (a, s, l) {
      return {
        ...
        link: function (e, t, n) {
          var i,
            o = e.$eval(n.actionsOpenPopupOptions);
          function r() {
            s.pleaseOpenPopup(o.popupId, i);
          }
          o.popupId &&
            s.shouldPopupBeOpened(o.actionId, o.recurrenceCondition, o.recurrenceOptions) &&
            ("always" !== o.recurrenceCondition &&
              (i = function () {
                s.updateDataInStorage(o.actionId, o.recurrenceCondition);
              }),
            "timer" === o.triggerType ? a(r, o.delayTime) : "placement" === o.triggerType && l.startWatching({ element: t, onEnter: r }));
        },
      };
    },
  ]),
  angular.module("website.widget.actions.scroll_to", []).directive("motoWidgetActionsScrollTo", [
    function () {
      return {
        ...
        link: function (e, t, n) {
          var i = n.anchor,
            o = 1e3 * parseFloat(n.time);
          angular.isDefined(i) &&
            t.on("click", function (e) {
              var t = $('a[name="' + i + '"]');
              e.preventDefault(), t.length && $("html, body").animate({ scrollTop: t.offset().top }, o);
            });
        },
      };
    },
              ...
              p.registry(c),
              {
                ...
                post: function (e, t, n) {
                    ...
                    a = {
                      onSliderLoad: function (e) {
                        ...
                        u && (u.destroy(), (u = null)),
                          ...
                          this.redrawSlider(),
                          (l = g.registerCallback(
                            function () {
                              var e;
                              m < 5 ? m++ : ((m = 0), (e = s.innerHeight()), d.eq(this.getCurrentSlide()).find(".moto-widget__content-wrapper>.moto-widget__content>.moto-cell").innerHeight() !== e && this.redrawSlider());
                            }.bind(this)
                          )),
                      ...
                      onSlideBefore: function (e, t, n) {
                        var i = c.getChild(t),
                          o = c.getChild(n);
                        i && i.onVanishing(), o && o.onArriving(r), f();
                      },
                      onSlideAfter: function (e, t, n) {
                        var i = c.getChild(t),
                          o = c.getChild(n);
                        i && i.onVanished(), o && o.onArrived(r);
                      },
                  ...
                  (e.params = e.$eval(n.motoContentSlider)),
                    ...
                    (o = angular.copy({ auto: !1, pause: 1e4, controls: !1, pager: !1, stopAutoOnClick: !0, autoControls: !1, autoControlsCombine: !0, preloadImages: "all" })),
                    angular.extend(o, e.params.options),
                    c.$content.find(">.moto-widget-content_slider__item").length <= 1 && ((o.controls = !1), (o.pager = !1)),
                    angular.extend(o, a),
                    e.$on("UserInteraction", function (e, t) {
                      "StartInteraction" === t && (i ? i.stopAuto() : (o.auto = !1));
                    }),
                    (i = c.$content.bxSlider(o)),
                    e.$on("$destroy", function () {
                      i && i.destroySlider(), u && (u.destroy(), (u = null)), l(), p.forget(c);
                    });
                },
              }
            );
  ...
  (function (o) {
    o.fn.motoCounter = function (e) {
      var t, n, i;
      if (!e || !angular.isObject(e)) return !1;
      (jQuery.easing.easeOutCirc = function (e, t, n, i, o) {
        return i * Math.sqrt(1 - (t = t / o - 1) * t) + n;
      }),
        (i = o.extend({}, { countFrom: 0, countTo: 100, duration: 3, easing: "easeOutCirc", complete: null, elementSelector: ".moto-widget-counter__value" }, e)),
        (t = o(this)),
        (n = t.find(i.elementSelector)),
        t.stop(),
        o({ count: i.countFrom }).animate(
          { count: i.countTo },
          {
  ...
  angular.module("website.core.form").directive("motoFormAttachmentButton", [
    ...
    function (a) {
      function s(e, t, n) {
        ...
        for (n = !!n, angular.isObject(t) && (t = Object.keys(t)), angular.isArray(t) || (t = [t]), i = 0, o = t.length; i < o; i++) e.$setValidity(t[i], n);
        return !0;
      }
      function l(e) {
      ...
      return {
        ...
        link: function (e, t, i, o) {
            ...
            s(o, o.$error, !0),
              (function (e) {
                var t,
                  n,
                  i = e.$modelValue;
                if ((i instanceof File && (i = [i]), angular.isArray(i) && !(i.length < 1))) for (t = 0, n = i.length; t < n; t++) s(e, i[t].$error, !1);
              })(o),
              i.required && (!(e = o).$modelValue || (angular.isArray(e.$modelValue) && e.$modelValue.length < 1)) && e.$setValidity("required", !1),
              o.$setTouched();
          }
          function r(e) {
            return a(n), e;
          ...
          e.$on("MotoForm::removeAttachedFile", function (e, t) {
            ...
            o.$modelValue === t && o.$setViewValue(void 0), angular.isArray(i.$$ngfPrevValidFiles) && -1 < (n = i.$$ngfPrevValidFiles.indexOf(t)) && i.$$ngfPrevValidFiles.splice(n, 1), angular.isArray(i.$$ngfPrevInvalidFiles) && -1 < (n = i.$$ngfPrevInvalidFiles.indexOf(t)) && i.$$ngfPrevInvalidFiles.splice(n, 1), r();
          }),
            o.$parsers.push(r),
            o.$parsers.push(l);
        },
  ...
  angular.module("website.core.form").directive("motoFormErrors", [
    function () {
      var i = { minlength: "The field lengths should be more than [[ MIN_LENGTH ]] characters", maxlength: "The field lengths should not exceed [[ MAX_LENGTH ]] characters", min: "The value should be more than [[ MIN_VALUE ]]", max: "The value should not exceed [[ MAX_VALUE ]]", email: "Please enter a valid email", url: "Please enter a valid URL", number: "Please enter a valid number", tel: "Please enter a valid phone number", pattern: "Please enter a valid [[ PATTERN ]]", required: "The field is required", date: "Please enter a valid date in format YYYY-MM-DD", maxFileSize: "The file size should not exceed [[ MAX_SIZE ]]", fileExtension: "This file extension is not supported" },
        o = { minlength: "MIN_LENGTH", maxlength: "MAX_LENGTH", min: "MIN_VALUE", max: "MAX_VALUE", maxFileSize: "MAX_SIZE" };
      return {
        restrict: "A",
        ...
        link: function (e) {
          var t,
            n = null;
          if (!e.$FORM) return !1;
          if ((angular.isFunction(e.$FORM.getValidationMessages) && (n = angular.copy(e.$FORM.getValidationMessages())), angular.isObject(n) && !angular.isArray(n))) for (t in i) i.hasOwnProperty(t) && ((angular.isString(n[t]) && ((n[t] = n[t].trim()), 0 < n[t].length)) || (n[t] = i[t]));
          else n = angular.copy(i);
          if (angular.isObject(e.rules) && !angular.isArray(e.rules)) for (t in e.rules) e.rules.hasOwnProperty(t) && o[t] && n[t] && (n[t] = n[t].replace("[[ " + o[t] + " ]]", e.rules[t]));
          e.messages = n;
        },
      };
    },
        ...
        link: function (t, e, n) {
          (t.setWidgetId = function (e) {
            ...
            t.$on("MotoForm::submitSuccess", function () {
              i.reload(t.widgetId), (t.$FORM[n.fieldName].$invalid = !1), (t.$FORM[n.fieldName].$touched = !1);
            }),
            ...
            t.$on("MotoForm::submitRejected", function () {
              "invisible" === i.getInstance(t.widgetId).getAttribute("data-size") && i.execute(t.widgetId);
            });
        },
      };
    },
  ...
  angular.module("website.widget.integrations.opentable", []).directive("motoWidgetIntegrationsOpentableLoader", [
    function () {
      ...
      function o() {
        var e, t;
        i.length && !n && ((n = !0), (e = i.shift()), ((t = document.createElement("script")).src = e.src), t.addEventListener("load", r), e.$element[0].appendChild(t));
      }
      function r() {
        (n = !1), o();
      }
  ...
  (jQuery.fn.motoCallback = function () {
    var e = this,
      ...
      i = e.find(".moto-widget-callback__more-details-button"),
      o = e.find(".moto-widget-callback__more-details-wrapper"),
    ...
    t.on("click", function () {
      e.hasClass("moto-widget-callback_opened") ||
        ...
        r.animate({ width: 280 }, 200, function () {
          t.slideUp(200),
      ...
      i.on("click", function () {
        r.hasClass("moto-widget-callback__body_more-details-opened") ? (o.slideUp(400), r.removeClass("moto-widget-callback__body_more-details-opened")) : (o.slideDown(400), r.addClass("moto-widget-callback__body_more-details-opened"));
      });
  }),
  ...
  (function (c) {
    var e = ">.moto-widget-tabs__wrapper>.moto-widget-tabs__items-wrapper>.moto-widget-tabs__item",
      i = ">.moto-widget-tabs__wrapper>.moto-widget-tabs__headers-wrapper>.moto-widget-tabs__header",
      t = i + ",>.moto-widget-tabs__wrapper>.moto-widget-tabs__items-wrapper>.moto-widget-tabs__item>.moto-widget-tabs__header",
      u = "moto-widget-tabs__header_opened",
      d = c(window);
    function m(e, t) {
      var n = {};
      return (n.id = e), (n.$root = t.find("#" + e)), (n.$desktopHeader = t.find(i + '[data-tab="' + e + '"]')), (n.$mobileHeader = n.$root.find(">.moto-widget-tabs__header")), (n.$contentWrapper = n.$root.find(">.moto-widget-tabs__content-wrapper")), n;
    }
    c.fn.motoTabs = function (a) {
      var s = this,
        l = s.find(">.moto-widget-tabs__wrapper>.moto-widget-tabs__headers-wrapper>.moto-widget-tabs__header.moto-widget-tabs__header_opened").data("tab");
      "object" != typeof a && (a = {}),
        s.find(e).length &&
          (s.find(e + ":not(#" + l + ")").each(function () {
            a.onClosed && a.onClosed({ id: c(this).attr("id") });
          }),
          a.onOpened && a.onOpened({ id: l }),
          s.off("click", t),
        ...
        compile: function (e) {
          ...
          return {
            ...
            post: function () {
              e.motoTabs({
                onOpened: function (e) {
                  t.getChild(e.id).onArriving(i), t.getChild(e.id).onArrived(i);
                },
                onClosed: function (e) {
  ...
  (function (h) {
    h.fn.tileGallery = function () {
      var e = 250,
        r = { columns: [], margins: 0 },
        o = this,
        a = o.children(".moto-widget-tile-gallery__item-wrapper"),
        n = 0,
        s = !1,
        l = !1,
        c = angular.isDefined(o.data("tileGalleryJustifyHeight"));
      function u() {
      ...
      function p() {
        var e,
          ...
          i,
          o = h(a[0]);
        for (r.margins = parseInt(o.css("padding-bottom")), r.columns = [{ items: [o], heightWithPadding: o.innerHeight(), height: m(o) }], t = 1; t < a.length; t++) (e = h(a[t])).position().left > o.position().left ? ((i = e), r.columns.push({ items: [i], heightWithPadding: i.innerHeight(), height: m(i) })) : ((n = e), r.columns[r.columns.length - 1].items.push(n), (r.columns[r.columns.length - 1].heightWithPadding += n.innerHeight()), (r.columns[r.columns.length - 1].height += m(n))), (o = e);
      }
      function g(e) {
        ...
        s
          ...
          : (o.parent().css("height", ""),
            ...
            c &&
              ((i = u()),
              r.columns.forEach(function (e) {
                (t = i - (e.heightWithPadding - e.height)), (n = ((t / e.height) * 100).toFixed(1)), e.items.forEach(g, { newWidth: n });
              }),
              p()),
            o.parent().css("height", u() - r.margins + "px"),
            (l = !(s = !0)),
            setTimeout(function () {
              (s = !1), l && f();
            }, e));
      ...
      o.find(".moto-widget-tile-gallery__item-image").each(function (e, t) {
        (t.complete && 0 !== t.naturalHeight) || (n++, h(t).on("load", i));
      }),
        n || f(),
        (h("body").hasClass("moto-preview-mode_content") && !h("body").hasClass("moto-preview-mode_design")) || h(window).on("resize", f);
    };
  })(jQuery),
